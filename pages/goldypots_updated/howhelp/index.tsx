     ...
     <div className={cn('relative' , styles.bgstyle)}>
        <div className=" mt-[145px] xlmax:mt-[80px]  bg-[#032C32] xlmin:border-t-[2px] border-[#43F3FF]">
            <div className="">
                    ...
                    <div className="flex  flex-wrap justify-around items-center xlmax:flex-col-reverse ">
                        <div className="mdmax:my-[20px] xsmax:px-[25px]">
                        ...
                        <div className={cn('xlmax:mt-[70px] mdmax:mt-[90px] mdmax:hidden',styles.rankTable)}></div>
                        <div className={cn('xlmax:mt-[70px] mdmax:mt-[90px] mdmax:block hidden',styles.rankTableMobile)}></div>
                    </div>
            ...
            <div className="bg-[#011C20] mt-[60px] py-[20px]">
                <div className="flex justify-around items-center">
                    ...
                    <div className="smmax:block hidden ">
                        ...
                        <div className="text-[#FFFFFF] mb-[30px] text-[11px]">The top rankers will be rewarded G-Token with corresponding amount.</div>
