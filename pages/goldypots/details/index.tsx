              ...
              <div ref={ref} className="border-0 rounded-[16px] xsmax:rounded-[0] shadow-lg relative flex flex-col w-full xsmax:min-h-screen	 bg-[#02222A] outline-none focus:outline-none ">
                ...
                <div className="relative pt-2 flex-auto pb-[20px]">
                    <div className="flex justify-between items-center pl-[40px] pr-[30px] xsmax:hidden">
                        ...
                        <div className="flex justify-around mt-[3px]">
                            <div className={cn('z-10' , styles.ellipse)}>
                                <div className="flex justify-center h-full items-center text-[45px] text-[#FFFFFF]  -mt-[5px] font-black font-['system-ui']">7</div>
                                <div className={cn('-mt-[14px] ml-[13px] flex justify-center h-full  items-center text-[22px] text-[#FFFFFF] font-bold font-["system-ui"]  tracking-widest	' ,styles.subtitle)}>#4</div>
                            </div>
                            ...
                            <div className={cn('z-10',styles.ellipse)}>
                            <div className="flex justify-center h-full items-center text-[45px] text-[#FFFFFF] -mt-[5px] font-black font-['system-ui']">3</div>
                                <div className={cn('-mt-[14px] ml-[13px] flex justify-center h-full items-center text-[22px] text-[#FFFFFF] font-bold  font-["system-ui"] tracking-widest	' ,styles.subtitle)}>#4</div>
                            </div>
                        </div>
                    ...
                    <div className="pt-3">
                        ...
                        <div className="pl-[15px] pr-[10px] xsmin:pl-[43px] xsmin:pr-[35px] mt-[5px]">
                            
                            {
                                WinnerGoldypot?.slice(0,6).map((data,inx)=>(
                                    <div className="flex  mb-[6px] xsmax:mb-[10px]" key={inx}>
                                        <div className={cn("text-[19px] xsmax:text-[15px] pr-[20px]" , inx < 3 && 'text-[#43F3FF]' , inx >=3 && 'text-[white]')}>{data._No}</div>
                                        ...
                                        <div className="flex justify-between items-center w-[330px]">
                                            <div className="text-[white] text-[9px] ssmin:text-[11px] xsmin:text-[13px]">{data._email}</div>
                                            <div className="text-[white] text-[9px] ssmin:text-[11px] xsmin:text-[13px]">{data._address}</div>
                                        </div>
                                    </div>
                                ))
                               }
                        ...
                        <div className="pl-[15px] pr-[10px] xsmin:pl-[43px] xsmin:pr-[35px] mt-[10px]">
                            
                            {
                                WinnerGoldypot?.slice(6,10).map((data,inx)=>(
                                    <div className="flex  mb-[6px] xsmax:mb-[10px]" key={inx}>
                                        <div className="text-[white] text-[19px] xsmax:text-[15px]  pr-[20px]">{data._No}</div>
                                        <div className="text-[#43F3FF] text-[19px] xsmax:text-[15px] pr-[20px]"> <ReactCountryFlag countryCode={data._country} style={{width:'36px'}} svg /></div>
                                        <div className="flex justify-between items-center w-[330px]">
                                            <div className="text-[white] text-[9px] ssmin:text-[11px] xsmin:text-[13px]">{data._email}</div>
                                            <div className="text-[white] text-[9px] ssmin:text-[11px] xsmin:text-[13px]">{data._address}</div>
